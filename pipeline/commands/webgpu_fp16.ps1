# Optimization: webgpu with fp16 precision
# Model: microsoft/phi-2
$ErrorActionPreference = 'Stop'

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$LogFile = Join-Path $ScriptDir "..\logs\webgpu_fp16.log"
...
New-Item -ItemType Directory -Force -Path "pipeline\outputs\webgpu_fp16" | Out-Null
...
olive optimize `
    ...
    --precision fp16 `
    -o "pipeline\outputs\webgpu_fp16" `
    --device gpu 2>&1 | Tee-Object -FilePath $LogFile

Write-Host ''
Write-Host 'Optimization complete: webgpu fp16'